...
const BtnSpeaker = () => require('../image/btn_speaker.png');
const BtnSwitchCamera = () => require('../image/btn_switch_camera.png');
const BtnVideo = () => require('../image/btn_video.png');
const EnableCamera = () => require('../image/enable_camera.png');
const DisableCamera = () => require('../image/disable_camera.png');
const EnablePhotoflash = () => require('../image/enable_photoflash.png');
const DisablePhotoflash = () => require('../image/disable_photoflash.png');
const IconMuted = () => require('../image/icon_muted.png');
const IconSpeaker = () => require('../image/icon_speaker.png');
