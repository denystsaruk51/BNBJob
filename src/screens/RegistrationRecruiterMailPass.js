...
import {styles} from '../styles/registrationRecruiterMailPass.style';
...
class RegistrationRecruiterMailPass extends Component {
  constructor(props) {
    super(props)
    ...
    this.gotoRegistrationRecruiterSMS = this.gotoRegistrationRecruiterSMS.bind(this);
  ...
  gotoRegistrationRecruiterSMS() {
    const { siret, institutionName, recruiterType } = this.props;
    ...
    if(isValidEmail && isValidPassword && isValidPhoneNumber){
      // Actions.registrationRecruiterSMS({email, password, countryCode, phoneNumber, firstName, lastName, siret, institutionName, recruiterType});
      Actions.registrationRecruiterPrivacy({email, password, countryCode, phoneNumber, firstName, lastName, sirt, institutionName, recruiterType});
    }
  }
        ...
        <View style={styles.container}>
          ...
          <View style={styles.nextButtonView}>
              <TouchableOpacity 
                ...
                onPress={this.gotoRegistrationRecruiterSMS} >
                  <View>
...
export default connect(({routes}) => ({routes}))(RegistrationRecruiterMailPass)