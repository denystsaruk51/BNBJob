...
import {styles} from '../../styles/candidatePackGold.style';
import StatusBar from '../../components/StatusBar';
import I18n from '../../locale-data/i18n';

class CandidatePackGold extends Component {
  constructor(props) {
    super(props);
      ...
      <View style={styles.container}>
        ...
        <View style={styles.topView}>
          ...
          <View style={styles.descriptionView}>
            ...
            <Text style={styles.description}>{I18n.t('Add 6 pictures, Video 2mn')}</Text>
        ...
        <View style={styles.bottomView}>          
          <TouchableOpacity style={itemStyleOne} onPress={this.selectItemOne}>
            <Image style={styles.priceItemImg} source={require('../../image/ic_gold_offer.png')} />
          ...
          <TouchableOpacity style={itemStyleTwo} onPress={this.selectItemTwo}>
            ...
            <View style={styles.priceInfoView}>
              <Text style={styles.priceText}>73,95€</Text>
          ...
          <TouchableOpacity style={itemStyleThree} onPress={this.selectItemThree}>
            ...
            <View style={styles.priceInfoView}>
              <Text style={styles.priceText}>130,50€</Text>
...
export default connect(({routes}) => ({routes}))(CandidatePackGold);