...
import {styles} from '../styles/registrationCandidateSMS.style';
import StatusBar from '../components/StatusBar';
import SmsField from '../components/SmsField';
import I18n from '../locale-data/i18n';

class RegistrationCandidateSMS extends Component {
  constructor(props) {
    super(props);
    ...
    this.gotoRegistrationCandidatePrivacy = this.gotoRegistrationCandidatePrivacy.bind(this);
  ...
  handleVerify(){
    ...
    if(code.length === 4){
      this.gotoRegistrationCandidatePrivacy();
    }
  }
  gotoRegistrationCandidatePrivacy() {
...
export default connect(({routes}) => ({routes}))(RegistrationCandidateSMS);